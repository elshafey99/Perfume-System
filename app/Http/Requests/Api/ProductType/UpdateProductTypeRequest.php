...
class UpdateProductTypeRequest extends FormRequest
{
    ...
    {
        $productTypeId = $this->route('id');

        return [
            'code' => ['sometimes', 'required', 'string', 'max:255', 'unique:product_types,code,' . $productTypeId],
    ...
    {
        return [
            'code.required' => __('validation.required', ['attribute' => 'الكود']),
