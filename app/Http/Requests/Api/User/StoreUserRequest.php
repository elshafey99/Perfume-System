...
class StoreUserRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'username.max' => __('validation.max.string', ['attribute' => 'اسم المستخدم', 'max' => 255]),
            'username.unique' => __('validation.unique', ['attribute' => 'اسم المستخدم']),
            'password.min' => __('validation.min.string', ['attribute' => 'كلمة المرور', 'min' => 2]),
