...
class UpdateCompositionIngredientRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'ingredient_product_id' => ['sometimes', 'required', 'integer', 'exists:products,id'],
            'quantity' => ['sometimes', 'required', 'numeric', 'min:0.0001'],
            'unit' => ['sometimes', 'required', 'string', 'in:piece,gram,ml'],
